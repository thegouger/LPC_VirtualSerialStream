...
#define _CDC_CLASS_DEVICE_H_
	...
	/* Public Interface - May be used in end-application: */
		...
		/* Function Prototypes: */
			 ...
			 * @return	Nothing
			 */
			FILE* CDC_Device_CreateStream(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo) ATTR_NON_NULL_PTR_ARG(1);
	...
	/* Private Interface - For use in library only: */
		...
		/* Function Prototypes: */
				...
				static int CDC_Device_putchar(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo, char c) ATTR_NON_NULL_PTR_ARG(1);
				static int CDC_Device_getchar(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo) ATTR_NON_NULL_PTR_ARG(1);
				static int CDC_Device_getchar_Blocking(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo) ATTR_NON_NULL_PTR_ARG(1);
